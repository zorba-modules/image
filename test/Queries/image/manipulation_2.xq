...
(:~
 ...
 :)
declare %nondeterministic function local:test-rotate() as xs:boolean {
...
(:~
 : @return true if the man:rotate function works.
 :)
declare %nondeterministic function local:test-erase() as xs:boolean {
...
(:~
 ...
 :)
declare %nondeterministic function local:test-flop() as xs:boolean {
...
(:~
 ...
 :)
declare %nondeterministic function local:test-flip() as xs:boolean {
...
(:~
 ...
 :)
declare %nondeterministic function local:test-trim() as xs:boolean {
...
(:~
 ...
 :)
declare %nondeterministic function local:test-blur() as xs:boolean {
