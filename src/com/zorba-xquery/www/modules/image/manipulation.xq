...
(:~
 ...
 : @param $operator defines how the overlay image should be overlayed. This parameter has to be validated against "http://www.zorba-xquery.com/modules/image/image" schema.
...
(:~
 ...
 : @param $noise-type specifies the type of noise to add. This parameter has to be validated against "http://www.zorba-xquery.com/modules/image/image" schema. 
...
(:~
 ...
 : @error $error:IM001 If eighter of the passed xs:base64Binary is not a valid image.
...
(:~
 ...
 : @param $color is the color to make transparent (e.g. '#FFFFFF'). This parameter has to be validated against "http://www.zorba-xquery.com/modules/image/image" schema.
